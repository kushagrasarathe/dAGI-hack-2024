...
const TrainAgent = () => {
  return (
    <div>
      ...
      <div className="mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-full min-h-[730px]">
        {/* <!-- Heading --> */}
        <div className="flex flex-col space-y-1.5 pb-6 h-full">
          <h2 className="font-semibold text-lg tracking-tight border-b pb-4">
            Train Agent
          </h2>
        </div>
        ...
        <div className="flex items-center ">
          <form className="flex items-center justify-center w-full space-x-2">
            <Input placeholder="Type your message" value="" />
